...
function PatientLayout() {
  ...
  const navItems = [
    { path: "/patient/dashboard", icon: <LayoutDashboard className="size-4" />, label: "Dashboard" },
    { path: "/patient/request", icon: <Droplet className="size-4" />, label: "Request Blood" },
    { path: "/patient/requests", icon: <FileText className="size-4" />, label: "My Requests" },
    { path: "/patient/donors", icon: <Search className="size-4" />, label: "Find Donors" },
    { path: "/patient/chat", icon: <MessageCircle className="size-4" />, label: "Chat" },
  ];
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <header className="md:hidden bg-white border-b border-border fixed top-0 left-0 right-0 z-40 px-4 py-3 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-sm text-foreground">LifeLink Patient</span>
        </div>
        <button
      ...
      <main className={`md:ml-72 min-h-screen pt-16 md:pt-0 transition-all duration-300`}>
        ...
        <div className="hidden md:flex bg-white border-b border-border px-8 py-4 items-center justify-between sticky top-0 z-20">
          <div>
            ...
            <p className="text-xs text-muted-foreground">Welcome back, {user.full_name || "Patient"}</p>
          </div>
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="text-sm">
                <p className="font-medium text-foreground">{user.full_name || "Patient"}</p>
